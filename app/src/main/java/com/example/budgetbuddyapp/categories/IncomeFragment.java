...
public class IncomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        categoryList.add(new Category("6", "user1", "Lương", "Thu nhập", 7));
        categoryList.add(new Category("7", "user1", "Thưởng", "Thu nhập", 4));
        categoryList.add(new Category("8", "user1", "Đầu tư", "Thu nhập", 8));
        categoryList.add(new Category("9", "user1", "Bán hàng", "Thu nhập", 6));
